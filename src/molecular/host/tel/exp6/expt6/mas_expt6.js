...
function initial_function(){
    ...
    document.getElementById("demo").innerHTML = "దశ-సంఖ్య 1: పవర్ బటన్ పై పరికరం క్లిక్ చేసి, వాయిద్యం ప్రారంభించడానికి 30 నిమిషాలు వేచి ఉండండి.";
...
function removeClock() {
    ...
    document.getElementById("demo").innerHTML = "దశ-సంఖ్య 2: పొటాషియం డైక్రోమేట్ యొక్క తగిన సాంద్రతలకు (చెప్పండి, 0.001 M, 0.00075M, 0.001 M) మూడు సజల ద్రావణాలను తయారు చేయండి [దాని శోషణను కొలవవలసిన ద్రావణం యొక్క తగిన ఏకాగ్రతను ఎంచుకోవడానికి ఏకాగ్రత పట్టీపై క్లిక్ చేసి లాగండి] . మొదట అతి తక్కువ గా ration త పరిష్కారంతో ప్రారంభించాలి. శుభ్రమైన, పొడి బీకర్ తీసుకోవడానికి బీకర్‌పై క్లిక్ చేయండి.";
