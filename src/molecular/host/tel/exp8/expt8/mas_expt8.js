...
function initial_function(){
    ...
    document.getElementById("demo").innerHTML = "దశ-సంఖ్య 1: విశ్లేషించాల్సిన పరిష్కారాలు డ్రాప్-డౌన్ మెను నుండి అమ్మబడతాయి. ఏకాగ్రత స్కేల్ బార్ల నుండి పరిష్కార సాంద్రతలు ఎంపిక చేయబడతాయి & పవర్ బటన్‌పై క్లిక్ చేసే పరికరాన్ని ఆన్ చేయండి మరియు పరికరం ప్రారంభించడానికి 30 నిమిషాలు వేచి ఉండండి.";
