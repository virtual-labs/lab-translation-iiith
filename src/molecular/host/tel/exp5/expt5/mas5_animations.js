...
function beaker() {
  if(step_no==1){
        ...
        document.getElementById("demo").innerHTML = "దశ-సంఖ్య 3: ప్రయోగాత్మక పట్టికకు తీసుకెళ్లడానికి 2-నైట్రోఅనిలిన్ ఫ్లాస్క్ పై క్లిక్ చేయండి";
...
function flask() {
    if ( step_no == 2 && count == 1){
        ...
        moveImage();
        // Change to next intsruction to be followed.
        document.getElementById("demo").innerHTML = "దశ-సంఖ్య 4: శుభ్రమైన, పొడి బీకర్‌లో ద్రావణాన్ని పోయడానికి 2-నైట్రోనిలిన్ ఫ్లాస్క్‌పై క్లిక్ చేయండి";
        step_no ++;
    }
