...
function beaker() {
    if(step_no==1){
      ...
      document.getElementById("demo").innerHTML = "దశ సంఖ్య 3: ఫ్లాస్క్‌ను ప్రయోగాత్మక పట్టికకు తీసుకెళ్లడానికి క్లిక్ చేయండి";
...
function flask() {
  if (step_no == 2 && count == 1){
    ...
    moveImage();
    // Change to next intsruction to be followed.
    document.getElementById("demo").innerHTML = "దశ సంఖ్య 4: శుభ్రమైన, పొడి బీకర్‌లో ద్రావణాన్ని పోయడానికి ఫ్లాస్క్‌పై క్లిక్ చేయండి";
    step_no++;
  }
...
function moveFlask() {
  ...
  // Change to next intsruction to be followed.
  document.getElementById("demo").innerHTML = "దశ 5: బీకర్ నుండి తగిన పరిమాణంలో ద్రావణాన్ని సేకరించడానికి మైక్రోపిపెట్ పై క్లిక్ చేయండి";
...
function pipette() {
  if (step_no == 4 && count == 4){
    ...
    fillPipette();
    // Change to next instruction to be followed.
    document.getElementById("demo").innerHTML = "6 వ దశ: దానిపై క్లిక్ చేయడం ద్వారా కువెట్టే తీసుకోండి";
    step_no ++;
  }
