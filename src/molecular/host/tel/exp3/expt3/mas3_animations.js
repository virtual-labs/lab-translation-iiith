...
function cuvette(event){
    if ( step_no == 6 && count == 6){
        ...
        document.getElementById("demo").innerHTML = "దశ-సంఖ్య 7: పైపెట్ పై క్లిక్ చేయడం ద్వారా మైక్రోపిపెట్ నుండి క్యూవెట్‌లోకి ద్రావణాన్ని పోయండి (వాస్తవ కొలతలలో క్యూట్ దాని వాల్యూమ్‌లో మూడింట రెండు వంతుల వరకు నిండి ఉంటుంది";
